...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2024 a las 18:26:18
...
CREATE TABLE `clientes` (
  ...
  `direcciom` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `clientes` (`cliente_id`, `usuario_id`, `nombre`, `apellido`, `fecha_nac`, `dni`, `ruc`, `correo`, `telefono`, `direccion`, `direcciom`) VALUES
(1, NULL, 'Carlos', 'Pérez', '1985-05-10', 12345678, 2147483647, 'carlos.perez@gmail.com', '+34-612345678', 'Calle Falsa 123, Madrid, España', NULL),
(2, NULL, 'Ana', 'González', '1990-11-22', 23456789, 2147483647, 'ana.gonzalez@yahoo.com', '+1-555-2345678', 'Av. Libertador 2345, Buenos Aires, Argentina', NULL),
(3, NULL, 'Luis', 'Martínez', '1982-02-14', 34567890, 2147483647, 'luis.martinez@hotmail.com', '+44-7911-234567', '10 Downing Street, Londres, Reino Unido', NULL),
(4, NULL, 'Marta', 'López', '1995-04-17', 45678901, 2147483647, 'marta.lopez@outlook.com', '+33-612345678', 'Rue de Paris 45, París, Francia', NULL),
(5, NULL, 'José', 'Hernández', '1978-09-05', 56789012, 2147483647, 'jose.hernandez@mail.com', '+52-55-12345678', 'Calle Reforma 101, Ciudad de México, México', NULL),
(6, NULL, 'María', 'Rodríguez', '1992-08-30', 67890123, 2147483647, 'maria.rodriguez@icloud.com', '+49-151-23456789', 'Alexanderplatz 15, Berlín, Alemania', NULL),
(7, NULL, 'Pedro', 'García', '1990-01-12', 78901234, 2147483647, 'pedro.garcia@aol.com', '+1-800-2345678', 'Main Street 500, Los Angeles, USA', NULL),
(8, NULL, 'Laura', 'Sánchez', '1988-03-20', 89012345, 2147483647, 'laura.sanchez@live.com', '+61-412345678', 'King Street 50, Sídney, Australia', NULL),
(9, NULL, 'Ricardo', 'Ramírez', '1993-07-25', 90123456, 2147483647, 'ricardo.ramirez@gmail.com', '+34-612345679', 'Gran Via 15, Barcelona, España', NULL),
(10, NULL, 'Beatriz', 'Díaz', '1987-10-08', 12345679, 2147483647, 'beatriz.diaz@yahoo.com', '+39-320-1234567', 'Via Roma 55, Roma, Italia', NULL),
(11, NULL, 'Sofía', 'Martín', '1994-09-15', 12346789, 2147483647, 'sofia.martin@outlook.com', '+34-622345679', 'Carrer de Balmes 101, Barcelona, España', NULL),
(12, NULL, 'Javier', 'Fernández', '1980-01-11', 23457890, 2147483647, 'javier.fernandez@icloud.com', '+54-911-2345678', 'Av. 9 de Julio 750, Buenos Aires, Argentina', NULL),
(13, NULL, 'Esteban', 'Vázquez', '1992-03-30', 34568901, 2147483647, 'esteban.vazquez@hotmail.com', '+1-212-2345678', '5th Ave 200, New York, USA', NULL),
(14, NULL, 'Elena', 'Torres', '1986-12-22', 45679012, 2147483647, 'elena.torres@mail.com', '+44-793-234567', 'Oxford Street 80, Londres, Reino Unido', NULL),
(15, NULL, 'Gabriel', 'Gutiérrez', '1990-05-05', 56789123, 2147483647, 'gabriel.gutierrez@aol.com', '+33-670123456', 'Champs-Élysées 75, París, Francia', NULL),
(16, NULL, 'Clara', 'Jiménez', '1988-07-14', 67890234, 2147483647, 'clara.jimenez@gmail.com', '+52-55-23456789', 'Paseo de la Reforma 120, Ciudad de México, México', NULL),
(17, NULL, 'Andrés', 'Alvarez', '1995-06-28', 78901345, 2147483647, 'andres.alvarez@live.com', '+49-1701234567', 'Kurfürstendamm 40, Berlín, Alemania', NULL),
(18, NULL, 'Patricia', 'Moreno', '1983-08-19', 89012456, 2147483647, 'patricia.moreno@outlook.com', '+61-412345678', 'George St 75, Sídney, Australia', NULL),
(19, NULL, 'Felipe', 'Ruiz', '1989-10-10', 90123567, 2147483647, 'felipe.ruiz@gmail.com', '+34-612345680', 'Avenida Brasil 500, Madrid, España', NULL),
(20, NULL, 'Beatriz', 'Serrano', '1984-02-23', 12346790, 2147483647, 'beatriz.serrano@yahoo.com', '+1-415-2345678', 'Mission Street 120, San Francisco, USA', NULL),
(21, NULL, 'Santiago', 'Vega', '1982-03-17', 12347890, 2147483647, 'santiago.vega@gmail.com', '+34-612345681', 'Calle del Mar 200, Valencia, España', NULL),
(22, NULL, 'Carla', 'Santos', '1991-07-22', 23457901, 2147483647, 'carla.santos@yahoo.com', '+1-555-2345679', 'Av. Paulista 800, São Paulo, Brasil', NULL),
(23, NULL, 'Felipe', 'Castro', '1994-06-12', 34568012, 2147483647, 'felipe.castro@hotmail.com', '+44-7911-234568', '1 Kingsway, Londres, Reino Unido', NULL),
(24, NULL, 'Lorena', 'Gutiérrez', '1988-04-25', 45679123, 2147483647, 'lorena.gutierrez@outlook.com', '+33-612345679', 'Avenue des Champs-Élysées 78, París, Francia', NULL),
(25, NULL, 'Manuel', 'Torres', '1980-11-05', 56789234, 2147483647, 'manuel.torres@mail.com', '+52-55-34567890', 'Calle Juárez 10, Guadalajara, México', NULL),
(26, NULL, 'Gabriela', 'Mendoza', '1992-10-15', 67890345, 2147483647, 'gabriela.mendoza@icloud.com', '+49-1702345678', 'Münchener Str. 12, Berlín, Alemania', NULL),
(27, NULL, 'Diego', 'Serrano', '1995-02-02', 78901456, 2147483647, 'diego.serrano@live.com', '+61-412345679', 'Flinders Street 65, Melbourne, Australia', NULL),
(28, NULL, 'Nuria', 'Paredes', '1983-09-09', 89012567, 2147483647, 'nuria.paredes@aol.com', '+39-3202345678', 'Piazza del Duomo 5, Milán, Italia', NULL),
(29, NULL, 'Oscar', 'Ruiz', '1990-05-14', 90123678, 2147483647, 'oscar.ruiz@outlook.com', '+34-672345680', 'Avenida de América 99, Madrid, España', NULL),
(30, NULL, 'Lina', 'García', '1984-08-01', 12347901, 2147483647, 'lina.garcia@gmail.com', '+1-408-2345678', 'Silicon Valley 400, San Francisco, USA', NULL),
(31, NULL, 'Raúl', 'Rodríguez', '1996-12-10', 23458012, 2147483647, 'raul.rodriguez@hotmail.com', '+44-7944-234569', 'High Street 50, Edimburgo, Reino Unido', NULL),
(32, NULL, 'Elisa', 'Márquez', '1991-01-05', 34568123, 2147483647, 'elisa.marquez@icloud.com', '+52-55-45678901', 'Av. Insurgentes 850, Ciudad de México, México', NULL),
(33, NULL, 'Fernando', 'Jiménez', '1987-06-17', 45679234, 2147483647, 'fernando.jimenez@aol.com', '+33-632123456', 'Rue de la République 35, Lyon, Francia', NULL),
(34, NULL, 'Silvia', 'Morales', '1989-04-30', 56789345, 2147483647, 'silvia.morales@mail.com', '+49-1603456789', 'Gendarmenmarkt 18, Berlín, Alemania', NULL),
(35, NULL, 'Antonio', 'Castillo', '1993-09-23', 67890456, 2147483647, 'antonio.castillo@outlook.com', '+1-646-2345678', 'Broadway 400, New York, USA', NULL),
(36, NULL, 'Julia', 'Ríos', '1990-01-22', 78901567, 2147483647, 'julia.rios@live.com', '+44-7421-234570', 'Oxford Street 120, Londres, Reino Unido', NULL),
(37, NULL, 'Ricardo', 'Vázquez', '1986-03-14', 89012678, 2147483647, 'ricardo.vazquez@icloud.com', '+33-612234567', 'Boulevard Saint-Germain 50, París, Francia', NULL),
(38, NULL, 'Valeria', 'Moreno', '1995-08-19', 90124789, 2147483647, 'valeria.moreno@gmail.com', '+34-612345681', 'Carrer de Pau Claris 90, Barcelona, España', NULL),
(39, NULL, 'Sergio', 'Núñez', '1988-12-28', 12348012, 2147483647, 'sergio.nunez@yahoo.com', '+52-55-56789012', 'Av. Paseo de la Reforma 100, Ciudad de México, México', NULL),
(40, NULL, 'Claudia', 'Álvarez', '1985-06-05', 23459123, 2147483647, 'claudia.alvarez@hotmail.com', '+49-1703456789', 'Grote Markt 45, Ámsterdam, Países Bajos', NULL),
(41, NULL, 'Tomás', 'Herrera', '1992-11-17', 34560234, 2147483647, 'tomas.herrera@aol.com', '+1-213-2345678', 'Sunset Blvd 600, Los Angeles, USA', NULL),
(42, NULL, 'Victoria', 'Fuentes', '1993-03-29', 45671345, 2147483647, 'victoria.fuentes@outlook.com', '+44-7911-234571', 'Baker Street 221B, Londres, Reino Unido', NULL),
(43, NULL, 'Jorge', 'González', '1989-02-19', 56782456, 2147483647, 'jorge.gonzalez@mail.com', '+52-55-67890123', 'Calle Reforma 1050, Ciudad de México, México', NULL),
(44, NULL, 'Isabel', 'Ruiz', '1982-07-01', 67893567, 2147483647, 'isabel.ruiz@gmail.com', '+49-1704567890', 'Karl-Marx-Allee 100, Berlín, Alemania', NULL),
(45, NULL, 'Luis', 'Castro', '1991-05-13', 78904678, 2147483647, 'luis.castro@live.com', '+34-672345682', 'Avenida 9 de Julio 600, Buenos Aires, Argentina', NULL),
(46, NULL, 'Juliana', 'Reyes', '1990-02-09', 89015789, 2147483647, 'juliana.reyes@outlook.com', '+33-612345678', 'Rue de Rivoli 101, París, Francia', NULL),
(47, NULL, 'Ricardo', 'Martín', '1984-04-25', 90126890, 2147483647, 'ricardo.martin@icloud.com', '+61-412345680', 'Queen St 120, Brisbane, Australia', NULL),
(48, NULL, 'Cristina', 'Molina', '1987-01-15', 12349101, 2147483647, 'cristina.molina@gmail.com', '+1-212-2345689', 'Park Ave 450, New York, USA', NULL),
(49, NULL, 'Fernando', 'Sánchez', '1992-11-25', 23450212, 2147483647, 'fernando.sanchez@yahoo.com', '+52-55-23456789', 'Avenida Insurgentes 300, Ciudad de México, México', NULL),
(50, NULL, 'Andrea', 'Gómez', '1993-05-04', 34561323, 2147483647, 'andrea.gomez@hotmail.com', '+49-1602345678', 'Friedrichstr. 50, Berlín, Alemania', NULL);
...
INSERT INTO `empleados` (`empleado_id`, `usuario_id`, `rango`, `nombre`, `apellido`, `fecha_nac`, `dni`, `correo`, `telefono`, `direccion`, `fecha`, `fe`, `fec`, `fech`) VALUES
(1, NULL, 'Gerente', 'Anna', 'Müller', '1990-01-05', 0, 'anna.mueller@xyzcorp.de', '+49 30 123456', 'Berliner Str. 25, Berlin, Germany', NULL, NULL, NULL, NULL),
(2, NULL, 'Supervisor', 'Max', 'Schmidt', '1985-05-20', 0, 'max.schmidt@globaltech.de', '+49 40 987654', 'Hamburger Allee 100, Hamburg, Germany', NULL, NULL, NULL, NULL),
(3, NULL, 'Analista', 'Emma', 'Schneider', '1993-12-15', 0, 'emma.schneider@abccompany.de', '+49 69 543210', 'Frankfurter Str. 55, Frankfurt, Germany', NULL, NULL, NULL, NULL),
(4, NULL, 'Asistente', 'Paul', 'Fischer', '1987-03-11', 0, 'paul.fischer@xyzcorp.de', '+49 341 678901', 'Leipziger Str. 12, Leipzig, Germany', NULL, NULL, NULL, NULL),
(5, NULL, 'Gerente', 'Lara', 'Weber', '1992-07-22', 0, 'lara.weber@globaltech.de', '+49 711 234567', 'Stuttgart Allee 33, Stuttgart, Germany', NULL, NULL, NULL, NULL),
(6, NULL, 'Operador', 'Julia', 'Becker', '1990-09-14', 0, 'julia.becker@abccompany.de', '+49 351 345678', 'Dresdner Str. 90, Dresden, Germany', NULL, NULL, NULL, NULL),
(7, NULL, 'Supervisor', 'Luca', 'Hoffmann', '1995-11-30', 0, 'luca.hoffmann@xyzcorp.de', '+49 421 456789', 'Bremer Weg 45, Bremen, Germany', NULL, NULL, NULL, NULL),
(8, NULL, 'Analista', 'Sophie', 'Meyer', '1991-02-17', 0, 'sophie.meyer@globaltech.de', '+49 511 567890', 'Hannover Str. 80, Hannover, Germany', NULL, NULL, NULL, NULL),
(9, NULL, 'Asistente', 'Leo', 'Wagner', '1986-06-25', 0, 'leo.wagner@abccompany.de', '+49 89 678901', 'Munich Allee 23, Munich, Germany', NULL, NULL, NULL, NULL),
(10, NULL, 'Operador', 'Maria', 'Koch', '1988-04-18', 0, 'maria.koch@xyzcorp.de', '+49 221 789012', 'Cologne Str. 10, Cologne, Germany', NULL, NULL, NULL, NULL),
(11, NULL, 'Gerente', 'Alex', 'Bauer', '1985-07-09', 123456789, 'alex.bauer@globaltech.de', '+1 617 1234567', 'Boston Ave 22, Boston, USA', NULL, NULL, NULL, NULL),
(12, NULL, 'Supervisor', 'Clara', 'Zimmermann', '1990-08-15', 234567890, 'clara.zimmermann@abccompany.com', '+1 212 2345678', 'New York St 88, New York, USA', NULL, NULL, NULL, NULL),
(13, NULL, 'Analista', 'Nina', 'Schäfer', '1993-11-20', 345678901, 'nina.schaefer@xyzcorp.com', '+1 312 3456789', 'Chicago Ave 47, Chicago, USA', NULL, NULL, NULL, NULL),
(14, NULL, 'Asistente', 'Daniel', 'Krause', '1989-03-03', 456789012, 'daniel.krause@globaltech.com', '+1 305 4567890', 'Miami Blvd 30, Miami, USA', NULL, NULL, NULL, NULL),
(15, NULL, 'Gerente', 'Mia', 'Lehmann', '1994-10-10', 567890123, 'mia.lehmann@abccompany.com', '+1 415 5678901', 'San Francisco St 54, San Francisco, USA', NULL, NULL, NULL, NULL),
(16, NULL, 'Operador', 'Henry', 'Schulz', '1987-06-18', 678901234, 'henry.schulz@xyzcorp.com', '+1 972 6789012', 'Dallas Pkwy 18, Dallas, USA', NULL, NULL, NULL, NULL),
(17, NULL, 'Supervisor', 'Eva', 'Maier', '1992-01-14', 789012345, 'eva.maier@globaltech.com', '+1 310 7890123', 'Los Angeles Blvd 29, Los Angeles, USA', NULL, NULL, NULL, NULL),
(18, NULL, 'Analista', 'Lisa', 'Huber', '1991-05-22', 890123456, 'lisa.huber@abccompany.com', '+1 713 8901234', 'Houston Str. 60, Houston, USA', NULL, NULL, NULL, NULL),
(19, NULL, 'Asistente', 'Erik', 'König', '1986-12-01', 901234567, 'erik.koenig@xyzcorp.com', '+1 206 9012345', 'Seattle Ave 77, Seattle, USA', NULL, NULL, NULL, NULL),
(20, NULL, 'Operador', 'Olivia', 'Frank', '1995-09-27', 12345678, 'olivia.frank@globaltech.com', '+1 303 0123456', 'Denver St 31, Denver, USA', NULL, NULL, NULL, NULL),
(21, NULL, 'Gerente', 'Hans', 'Gruber', '1985-08-09', 0, 'hans.gruber@xyzcorp.de', '+49 6221 123456', 'Heidelberger Str. 50, Heidelberg, Germany', NULL, NULL, NULL, NULL),
(22, NULL, 'Supervisor', 'Greta', 'Wolf', '1993-10-05', 0, 'greta.wolf@globaltech.de', '+49 761 987654', 'Freiburger Str. 75, Freiburg, Germany', NULL, NULL, NULL, NULL),
(23, NULL, 'Analista', 'Lukas', 'Hartmann', '1990-06-12', 0, 'lukas.hartmann@abccompany.de', '+49 6131 543210', 'Mainzer Allee 32, Mainz, Germany', NULL, NULL, NULL, NULL),
(24, NULL, 'Asistente', 'Sara', 'Neumann', '1994-11-25', 0, 'sara.neumann@xyzcorp.de', '+49 621 678901', 'Mannheimer Str. 19, Mannheim, Germany', NULL, NULL, NULL, NULL),
(25, NULL, 'Gerente', 'Felix', 'Scholz', '1987-02-15', 0, 'felix.scholz@globaltech.de', '+49 231 234567', 'Dortmunder Weg 45, Dortmund, Germany', NULL, NULL, NULL, NULL),
(26, NULL, 'Operador', 'Emma', 'Lang', '1991-05-18', 0, 'emma.lang@abccompany.de', '+49 228 345678', 'Bonn Str. 65, Bonn, Germany', NULL, NULL, NULL, NULL),
(27, NULL, 'Supervisor', 'Noah', 'Klein', '1989-12-02', 0, 'noah.klein@xyzcorp.de', '+49 241 456789', 'Aachener Str. 22, Aachen, Germany', NULL, NULL, NULL, NULL),
(28, NULL, 'Analista', 'Lara', 'Seidel', '1995-03-29', 0, 'lara.seidel@globaltech.de', '+49 9131 567890', 'Erlanger Str. 50, Erlangen, Germany', NULL, NULL, NULL, NULL),
(29, NULL, 'Asistente', 'Julia', 'Walter', '1988-09-03', 0, 'julia.walter@abccompany.de', '+49 931 678901', 'Würzburger Str. 75, Würzburg, Germany', NULL, NULL, NULL, NULL),
(30, NULL, 'Operador', 'Oliver', 'Zimmer', '1992-07-22', 0, 'oliver.zimmer@xyzcorp.de', '+49 541 789012', 'Osnabrücker Str. 18, Osnabrück, Germany', NULL, NULL, NULL, NULL),
(31, NULL, 'Gerente', 'Hanna', 'Krämer', '1985-11-11', 901283746, 'hanna.kraemer@globaltech.de', '+1 801 1234567', 'Salt Lake Blvd 40, Salt Lake City, USA', NULL, NULL, NULL, NULL),
(32, NULL, 'Supervisor', 'Leo', 'Schuster', '1989-03-14', 801234567, 'leo.schuster@abccompany.com', '+1 619 2345678', 'San Diego St 90, San Diego, USA', NULL, NULL, NULL, NULL),
(33, NULL, 'Analista', 'Mia', 'Brandt', '1993-08-29', 701234567, 'mia.brandt@xyzcorp.com', '+1 404 3456789', 'Atlanta Ave 60, Atlanta, USA', NULL, NULL, NULL, NULL),
(34, NULL, 'Asistente', 'Eva', 'Lorenz', '1991-12-22', 601234567, 'eva.lorenz@globaltech.com', '+1 512 4567890', 'Austin Blvd 20, Austin, USA', NULL, NULL, NULL, NULL),
(35, NULL, 'Gerente', 'Henry', 'Arnold', '1986-10-07', 501234567, 'henry.arnold@abccompany.com', '+1 602 5678901', 'Phoenix Str. 12, Phoenix, USA', NULL, NULL, NULL, NULL),
(36, NULL, 'Operador', 'Alex', 'Simon', '1990-05-19', 401234567, 'alex.simon@xyzcorp.com', '+1 503 6789012', 'Portland Ave 42, Portland, USA', NULL, NULL, NULL, NULL),
(37, NULL, 'Supervisor', 'Clara', 'Hauser', '1995-02-13', 301234567, 'clara.hauser@globaltech.com', '+1 702 7890123', 'Las Vegas Blvd 77, Las Vegas, USA', NULL, NULL, NULL, NULL),
(38, NULL, 'Analista', 'Daniel', 'Koch', '1987-01-18', 201234567, 'daniel.koch@abccompany.com', '+1 215 8901234', 'Philadelphia St 30, Philadelphia, USA', NULL, NULL, NULL, NULL),
(39, NULL, 'Asistente', 'Lisa', 'Meier', '1992-06-05', 101234567, 'lisa.meier@xyzcorp.com', '+1 704 9012345', 'Charlotte St 54, Charlotte, USA', NULL, NULL, NULL, NULL),
(40, NULL, 'Operador', 'Nina', 'Berg', '1988-04-09', 91234567, 'nina.berg@globaltech.com', '+1 313 0123456', 'Detroit Str. 90, Detroit, USA', NULL, NULL, NULL, NULL),
(41, NULL, 'Gerente', 'Hans', 'Fuchs', '1990-03-15', 0, 'hans.fuchs@abccompany.de', '+49 431 123456', 'Kiel Str. 28, Kiel, Germany', NULL, NULL, NULL, NULL),
(42, NULL, 'Supervisor', 'Anna', 'Reuter', '1994-09-12', 0, 'anna.reuter@xyzcorp.de', '+49 331 987654', 'Potsdamer Str. 19, Potsdam, Germany', NULL, NULL, NULL, NULL),
(43, NULL, 'Analista', 'Max', 'Kuhn', '1991-10-08', 0, 'max.kuhn@globaltech.de', '+49 451 543210', 'Lübecker Weg 50, Lübeck, Germany', NULL, NULL, NULL, NULL),
(44, NULL, 'Asistente', 'Emma', 'Stein', '1989-12-25', 0, 'emma.stein@abccompany.de', '+49 381 678901', 'Rostocker Str. 10, Rostock, Germany', NULL, NULL, NULL, NULL),
(45, NULL, 'Operador', 'Paul', 'Witt', '1993-07-17', 0, 'paul.witt@xyzcorp.de', '+49 391 234567', 'Magdeburger Allee 22, Magdeburg, Germany', NULL, NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `usuario$roles`
--
...
CREATE TABLE `usuario_roles` (
  ...
  `roles_rol_id` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `usuario$roles`
--
ALTER TABLE `usuario$roles`
  ADD PRIMARY KEY (`rol_id`);
...
ALTER TABLE `usuario_roles`
  ADD PRIMARY KEY (`usuarios_usuario_id`,`roles_rol_id`),
  ADD KEY `FK417wat91aehj4uph1w5p8eg04` (`roles_rol_id`);
...
--
ALTER TABLE `clientes`
  MODIFY `cliente_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
-- AUTO_INCREMENT de la tabla `usuario$roles`
--
ALTER TABLE `usuario$roles`
...
--
ALTER TABLE `usuario_roles`
  ADD CONSTRAINT `FK29bhnd6mbq3cnpawatot1fmge` FOREIGN KEY (`usuarios_usuario_id`) REFERENCES `usuario` (`usuario_id`),
  ADD CONSTRAINT `FK417wat91aehj4uph1w5p8eg04` FOREIGN KEY (`roles_rol_id`) REFERENCES `usuario$roles` (`rol_id`);
COMMIT;
